    ...
    const skillGroups = [
        {
            ...
            skills: [
                ...
                { name: "JavaScript", icon: "mdi:language-javascript", color: "text-yellow-400" },
                { name: "Dart", icon: "simple-icons:dart", color: "text-blue-400" },
                { name: "Python", icon: "mdi:language-python", color: "text-yellow-400" },
                { name: "C", icon: "mdi:language-c", color: "text-blue-400" },
                { name: "PHP", icon: "mdi:language-php", color: "text-blue-400" },
                { name: "Java", icon: "mdi:language-java", color: "text-blue-500" },
                { name: "Node.js", icon: "simple-icons:nodedotjs", color: "text-emerald-400" },
                { name: "Lua", icon: "simple-icons:lua", color: "text-blue-400" },
        ...
        },
        {
            title: "Frameworks",
            skills: [
                { name: "Next.js 16", icon: "ri:nextjs-fill", color: "text-slate-900 dark:text-white" },
        ...
        },
        {
            ...
            skills: [
                ...
                { name: "Firebase", icon: "simple-icons:firebase", color: "text-orange-500" },
                { name: "MongoDB", icon: "simple-icons:mongodb", color: "text-blue-400" },
                ...
                { name: "Vercel", icon: "simple-icons:vercel", color: "text-slate-900 dark:text-white" },
            ]
        },
        {
            title: "IoT & Hardware",
            skills: [
                { name: "ESP32", icon: "simple-icons:espressif", color: "text-red-500" },
                { name: "ESP8266", icon: "simple-icons:espressif", color: "text-red-400" },
                { name: "Arduino", icon: "simple-icons:arduino", color: "text-teal-500" },
                { name: "Sensors", icon: "mdi:sensor", color: "text-blue-400" },
                { name: "Relay", icon: "mdi:electric-switch", color: "text-yellow-500" },
            ]
        }
    ];
                        ...
                        <div className="flex overflow-hidden select-none gap-6 group">
                            <div className={`flex flex-nowrap gap-6 ${gIndex % 2 === 0 ? "animate-scroll-left" : "animate-scroll-right"} group-hover:pause-scroll`}>
                                {[...group.skills, ...group.skills, ...group.skills].map((skill, i) => (
                                    <div
                                        key={i}
                                        className="flex items-center gap-3 whitespace-nowrap px-8 py-4 rounded-2xl border font-mono font-bold tracking-wider text-sm transition-all duration-300 bg-white border-slate-200 text-slate-700 shadow-sm dark:bg-white/[0.02] dark:border-white/10 dark:text-slate-300 dark:hover:bg-white/5 dark:hover:border-white/20"
                                    >
